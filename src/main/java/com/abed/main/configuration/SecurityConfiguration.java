...
public class SecurityConfiguration  extends WebSecurityConfigurerAdapter{
	...
	{
		http.csrf().disable().authorizeRequests().antMatchers("/api/tickets/**").hasAnyRole("USER","ADMIN").and().formLogin().loginPage("/login").permitAll();;
		http.csrf().disable().authorizeRequests().antMatchers("/api/admin/**").hasAnyRole("ADMIN").and().formLogin().loginPage("/login").permitAll();;
